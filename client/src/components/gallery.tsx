export default function Gallery() {
  const galleryImages = [
    ...
    },
    {
      ...
      alt: "Artfully plated gourmet dish"
    },
    {
      id: 3,
      ...
      alt: "Restaurant bar with premium spirits"
    },
    {
      id: 4,
      src: "https://images.unsplash.com/photo-1600891964599-f61ba0e24092?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
      alt: "Chef plating artistic dessert"
    },
    {
      id: 5,
      ...
      alt: "Wine cellar with premium collection"
    },
    {
      id: 6,
      ...
      alt: "Outdoor terrace dining with view"
    }
  ];

  return (
    <section id="gallery" className="py-20 bg-moccasin/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-playfair font-bold text-dark-brown mb-4">Gallery</h2>
          <p className="text-xl text-gray-700">A glimpse into our culinary artistry and elegant ambiance</p>
        </div>
